...
// const totalImput = document.getElementsByClassName('total-input')[0];
...
// 			const selectName = select.options[select.selectIndex].textContent;
...
// 		screens[this.allCountScreens.length - 1].after(cloneScreen);
// 	},
// 	addServices: function() {
// 		otherItemsPercent.forEach(function(item) {
// 			const check = item.querySelector('input[type=checkbox]');
// 			const lable = item.querySelector('lable');
...
// 	},
// 	showResult: function() {
// 		totalImput.value = appData.screenPrice;
